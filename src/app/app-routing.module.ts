...
const routes: Routes = [
  ...
  { path: 'object', data: { itemType: ItemType.Object }, children: [
    ...
    { path: ':id', children: [
      ...
      { path: 'aerodynamics_general', component: AeroGeneralComponent, resolve: { form: FormResolver, sixDof: ObjectDofResolver } },
      { path: 'aerodynamics_axisymmetric', component: AeroAxiComponent, resolve: { form: FormResolver, sixDof: ObjectDofResolver } },
      { path: 'aerodynamics_wind', component: AeroWindComponent, resolve: { form: FormResolver, sixDof: ObjectDofResolver } },
      { path: 'aerodynamics_bodyfixed', component: AeroBodyComponent, resolve: { form: FormResolver, sixDof: ObjectDofResolver } },
